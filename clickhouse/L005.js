...
module.exports.parseAndInsert = async function(req) {
    ...
    for(let list of req.body.body.list) {
        let req_body = {};
        req_body = {message_id: req.body.header.message_id, ...list, sent_time: req.body.body.sent_time, date_time: setDateTime.setDateTime() };
        Array.push(req_body);
    }
